...
class Update_Job_Engineer_Field_Activity : AppCompatActivity() {
    ...
    private lateinit var rbWorkshopNeeded: RadioButton
    private lateinit var rbWorkshopNotNeeded: RadioButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_update_job_engineer_field)
        ...
        rbWorkshopNeeded = findViewById(R.id.rbWorkshopNeeded)
        rbWorkshopNotNeeded = findViewById(R.id.rbWorkshopNotNeeded)
...
//        }
        ...
        rbWorkshopNeeded.setOnClickListener { sendNotificationToRoles("Workshop Repair Needed", jobId) }
...
//    }
    ...
    private fun updateJobToFirestore(jobId: String) {
        ...
        val updateData = hashMapOf(
            ...
            "workshopRepair" to if (rbWorkshopNeeded.isChecked) "Needed" else "Not-Needed",
            "expense" to etExpense.text.toString(),
            "issues" to issues,
